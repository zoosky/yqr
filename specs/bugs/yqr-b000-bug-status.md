...
- Total bugs: 14
- Open: 4 (b014 — an empty collection at its key's own column is invalid YAML
  that noyalib accepts and its sole-entry `remove` writes; the validator half
  is **fixed** as of 2026-08-19 (`Y103`, default mode), leaving the upstream
  writer; b013 — an inserted scalar takes the document's dominant quote style,
