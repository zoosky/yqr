...
|-----|-------|----------|--------|---------|
| [b001](yqr-b001-roundtrip-discards-whitespace-and-formatting.md) | Round-trip through the default pipeline discards whitespace, comments, and formatting | High | Open (default pipeline is a lossy semantic round trip — now through noyalib, `yqr-m005`; the byte-faithful path is the fidelity engine, `yqr-f002`) | `yqr-a001`, `yqr-r001`, `yqr.f001`, `yqr-f002`, `yqr-m005` |
