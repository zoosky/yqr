...
- Total bugs: 14
- Open: 4 — **three filed upstream (b011, b012, b014), each with a fix
  proposed; b013 is not filed.**
  ...
  - **b013** — an inserted scalar takes the document's dominant quote style,
    ...
    spelling at every later edit site. **Not filed upstream**, and the only
    one of the four that is not.
  ...
  open here until a noyalib release carries it.
